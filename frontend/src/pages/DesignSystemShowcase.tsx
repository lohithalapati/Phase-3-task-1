      ...
      <Glass className='p-8 md:p-12'>
        <div className='grid grid-cols-1 md:grid-cols-2 gap-12'>
          <div className='space-y-8'>
            <h2 className='text-2xl font-bold border-b border-surface-border pb-4'>
              Premium Components
            </h2>
            ...
            <h2 className='text-2xl font-bold border-b border-surface-border pb-4 pt-4'>
              Status Indicator
            </h2>
          ...
          <div className='space-y-6'>
            ...
            <Glass interactive={true} className='p-6'>
              <h3 className='font-semibold mb-2'>Interactive Glass</h3>
