Write-Host "Adding health check tests..." -ForegroundColor Cyan
...
New-Item -ItemType Directory -Path "src/health/__tests__" -Force | Out-Null
$testCode | Out-File -FilePath "src/health/__tests__/HealthCheck.test.ts" -Encoding UTF8
Write-Host "Created src/health/__tests__/HealthCheck.test.ts" -ForegroundColor Green
