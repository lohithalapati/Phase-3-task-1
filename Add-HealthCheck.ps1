Write-Host "Adding health check endpoint..." -ForegroundColor Cyan
...
$healthCheckCode | Out-File -FilePath "src/health/HealthCheck.ts" -Encoding UTF8
Write-Host "Created src/health/HealthCheck.ts" -ForegroundColor Green
